...
SDK_BASE	?= /opt/Espressif/ESP8266_SDK/esp_iot_sdk_v1.5.3
...
LIBS		= c gcc  phy pp net80211 wpa main lwip crypto driver
#Add in esphttpd lib
LIBS += esphttpd
...
LDFLAGS		= -nostdlib -Wl,--no-check-sections -u call_user_start, -static
